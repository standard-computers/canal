...
public class Selectables {
    ...
    public static Selectable uoms(String preset) {
        ...
        statusTypes.put("ML", "ML");
        statusTypes.put("L", "L");
        statusTypes.put("MG", "MG");
        statusTypes.put("GAL", "GAL");
        statusTypes.put("G", "G");
        statusTypes.put("KG", "KG");
    ...
    public static Selectable packagingUoms() {
        ...
        statusTypes.put("BAG", "BAG");
        statusTypes.put("CASES", "CASES");
        statusTypes.put("CS", "CS");
        statusTypes.put("CARTON", "CARTON");
        statusTypes.put("CONTAINER", "CONTAINER");
        statusTypes.put("DRUM", "DRUM");
        statusTypes.put("DZ", "DZ");
        statusTypes.put("LOT", "LOT");
        statusTypes.put("PACK", "PACK");
        statusTypes.put("PALLETS", "PALLETS");
        statusTypes.put("REEMES", "REEMES");
        statusTypes.put("ROLL", "ROLL");
        statusTypes.put("TUBE", "TUBE");
        Selectable uomField = new Selectable(statusTypes);
    ...
    public static Selectable allPackagingUoms() {
