...
public class MoveStock extends LockeState {
    ...
    public MoveStock(String location, RefreshListener refreshListener) {
        ...
        f.addInput(Elements.coloredLabel("Destination Bin", Constants.colors[0]), destinationBins);
        f.addInput(Elements.coloredLabel("HU", Constants.colors[1]), mvHu);
        f.addInput(Elements.coloredLabel("Quantity", Constants.colors[2]), mvQty);
        f.addInput(Elements.coloredLabel("Create HU", Constants.colors[3]), createHu);
        f.addInput(Elements.coloredLabel("Create WT", Constants.colors[3]), createWt);
        f.addInput(Elements.coloredLabel("Split Divisor", Constants.colors[3]), split);
