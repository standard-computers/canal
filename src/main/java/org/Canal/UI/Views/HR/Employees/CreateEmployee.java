...
public class CreateEmployee extends JInternalFrame {
    ...
    public CreateEmployee(DesktopState desktop){
        ...
        Selectable genders = Selectables.genders();
        JCheckBox isVeteran = new JCheckBox();
        ...
        f.addInput(new Label("Gender", Constants.colors[5]), genders);
        f.addInput(new Label("Veteran?", Constants.colors[4]), isVeteran);
        ...
        Selectable ethnicities = Selectables.ethnicities();
        f2.addInput(new Label("Ethnicity", UIManager.getColor("Label.foreground")), ethnicities);
