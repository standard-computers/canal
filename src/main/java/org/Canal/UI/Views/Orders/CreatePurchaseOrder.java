...
public class CreatePurchaseOrder extends JInternalFrame {
    ...
    public CreatePurchaseOrder() {
        ...
        model = new ItemTableModel(Collections.singletonList(items.get(0)));
        ...
        save.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(ccc == JOptionPane.YES_OPTION){
                    ...
                    newOrder.setTaxAmount(taxRate * Double.valueOf(model.getTotalPrice()));
                    newOrder.setTotal(taxRate * Double.valueOf(model.getTotalPrice()) + Double.valueOf(model.getTotalPrice()));
    ...
    private JPanel orderSummary(){
        ...
        taxAmount = new JLabel("$" + df.format(taxRate * Double.valueOf(model.getTotalPrice())));
        taxAmount.setFont(UIManager.getFont("h3.font"));
        f.addInput(new JLabel("Tax Amount"), taxAmount);
        totalAmount = Labels.h2("$" + df.format(taxRate * Double.valueOf(model.getTotalPrice()) + Double.valueOf(model.getTotalPrice())));
    ...
    private void updateTotal(){
        ...
        taxAmount.setText("$" + df.format(taxRate * Double.valueOf(model.getTotalPrice())));
        totalAmount.setText("$" + df.format(taxRate * Double.valueOf(model.getTotalPrice()) + Double.valueOf(model.getTotalPrice())));
    }
}