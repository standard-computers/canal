...
public class ModifyBin extends LockeState {
    ...
    public ModifyBin(String location, Bin bin, RefreshListener refreshListener) {

        super("New Bin", "/BNS/NEW", false, true, false, true);
        setFrameIcon(new ImageIcon(ModifyBin.class.getResource("/icons/bins.png")));
    ...
    private JPanel toolbar() {
        ...
        copyFrom.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                String binId = JOptionPane.showInputDialog(ModifyBin.this, "Enter Bin ID", "Copy Bin", JOptionPane.QUESTION_MESSAGE);
                if(!binId.isEmpty()){
